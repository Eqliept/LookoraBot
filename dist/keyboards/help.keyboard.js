 ...
 */
export const getAgreementKeyboard = (ctx) => {
 ...
 */
export const getAgreementKeyboardByLang = (lang) => {
 ...
 */
export const getHelpMenuKeyboard = (ctx) => {
    return new InlineKeyboard()
...
//# sourceMappingURL=help.keyboard.js.map